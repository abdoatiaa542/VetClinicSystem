...
import com.example.Vet.Clinic.System.dto.*;
import com.example.Vet.Clinic.System.exception.ResourceAlreadyExistsException;
...
import com.example.Vet.Clinic.System.service.access_token.AccessTokenService;
import com.example.Vet.Clinic.System.utils.ContextHolderUtils;
...
public class AuthServiceImpl implements IAuthService {
    ...
    @Override
    public Object registerAdmin(RegistrationRequest request) {
        return registerWithRole(request, Role.ADMIN);
    }

    @Override
    public Object registerDoctor(RegistrationRequest request) {
        return registerWithRole(request, Role.DOCTOR);
    }

    @Override
    public Object registerOwner(RegistrationRequest request) {
        return registerWithRole(request, Role.OWNER);
    }

    private ApiResponse registerWithRole(RegistrationRequest request, Role role) {
        ...
        userRepository.save(user);
        return ApiResponse.of(role.name() + " registered successfully.");
    }
